...
- The event emission seam: its API, and how "reports a committed mutation" is honored against
  the transaction that raised it. Settled at its first consumer, the reference service's data
  work.
