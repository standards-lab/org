...
strategy (`auth-strategy.md` §7) actually built, and practical experience with how bounded
queries behave in production once it is.

`service-organization.md`'s runtime-composition rule composes data across services one stage at a
...
`service-organization.md` already names for search and reporting.
