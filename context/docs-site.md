...
The planned hosting: a thin `standards-lab.github.io` repository whose Actions
...
It waits until the initial reference architecture is in place. The diagram and voice standards
